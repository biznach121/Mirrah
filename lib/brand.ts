...
export const brand: Brand = {
  name: "Beauty by Mirrah",
  shortName: "Mirrah",
  microTag: "HAIR, BEAUTY AND CRAFT",
  description:
    "Beauty by Mirrah is a Accra beauty studio where treatments, care and calm come together under one roof.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0550011142",
    phoneTel: "+233550011142",
    textPhone: "0550011142",
    textPhoneTel: "+233550011142",
    email: "hello@mirrah.test",
    privacyEmail: "privacy@mirrah.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@beautybymirrah", icon: "tiktok" },
  ],
  ...
  hero: {
    badge: "Now booking",
    title: "made beautiful,\nby mirrah.\nHair, beauty and craft.",
    subtitle:
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "Beauty by Mirrah exists so that slowing down doesn't cost you your rhythm. One hour here gives back more than it takes — a genuine reset with a visible result.",
    ...
    images: [
      {
        ...
        alt: "Beauty by Mirrah beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Beauty by Mirrah self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Beauty by Mirrah beauty ritual",
      ...
      },
      {
        ...
        alt: "Beauty by Mirrah calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Beauty by Mirrah relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Beauty by Mirrah beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Beauty by Mirrah lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Beauty by Mirrah mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Beauty by Mirrah makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Beauty by Mirrah foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@beautybymirrah",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783462367/stage4/spa_beautybymirrah/tiktok_0.mp4",
        alt: "Beauty by Mirrah treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783462369/stage4/spa_beautybymirrah/tiktok_1.mp4",
        alt: "Beauty by Mirrah treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783462372/stage4/spa_beautybymirrah/tiktok_2.mp4",
        alt: "Beauty by Mirrah treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Beauty by Mirrah self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Beauty by Mirrah studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Beauty by Mirrah",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Beauty by Mirrah is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0550011142 and text 0550011142 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0550011142, text 0550011142, or message @beautybymirrah on Instagram." },
          ...
          { q: "Where are you located?", a: "Beauty by Mirrah is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@mirrah.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Beauty by Mirrah (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@mirrah.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Beauty by Mirrah is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@mirrah.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Beauty by Mirrah",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0550011142", href: "tel:+233550011142" },
      { label: "Text", value: "0550011142", href: "sms:+233550011142" },
      { label: "Instagram", value: "@beautybymirrah", href: "https://www.tiktok.com/@beautybymirrah" },
    ],
  },
  ...
  footer: {
    logoUrl: "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783462364/stage4/spa_beautybymirrah/avatar.jpg",
    blurb:
      "Beauty by Mirrah in Accra — hair, beauty and craft.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@beautybymirrah" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0550011142", href: "tel:+233550011142" },
          { label: "Text 0550011142", href: "sms:+233550011142" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Beauty by Mirrah — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
