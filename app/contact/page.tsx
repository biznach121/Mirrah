        ...
        <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-[1.35fr_0.85fr] lg:items-start">
          ...
          <aside className="grid gap-5">
            <div className="spabox-card p-6 sm:p-8">
              ...
              <ul className="m-0 list-none space-y-4 p-0">
                {c.directLines.map((line) => (
                  <li key={line.label}>
                    <p className="m-0 text-[12px] font-semibold uppercase text-[#b35b54]">
                      {line.label}
                    </p>
                    <a
                      href={line.href}
                      className="text-[18px] font-semibold text-[#4f0b47] transition-colors hover:text-[#b35b54]"
                    >
                      {line.value}
                    </a>
                  </li>
            ...
            <div className="spabox-card p-6 sm:p-8">
              ...
              <p className="m-0 text-[22px] font-semibold text-[#4f0b47]">{brand.contact.address}</p>
              <p className="mt-2 text-[14px] font-medium text-[#5c2252]/72">{brand.contact.hours}</p>
            </div>
          </aside>
        </div>
      </div>
