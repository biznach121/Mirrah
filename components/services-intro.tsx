...
export function ServicesIntro() {
  return (
    <section className="relative isolate overflow-hidden bg-[#fbddd9] px-6 pb-12 pt-8 text-[#4f0b47] sm:px-8">
      <svg
        className="pointer-events-none absolute -right-16 -top-36 z-0 h-72 w-72 text-[#a77278]/28"
        viewBox="0 0 320 320"
        fill="none"
        aria-hidden="true"
      >
