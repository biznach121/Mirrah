...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783462363/stage4/spa_beautybymirrah/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Beauty by Mirrah - Hair, beauty and craft">
        <Image
          src={src}
          alt="Beauty by Mirrah - Hair, beauty and craft"
          fill
