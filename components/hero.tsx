...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#860049] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#950058]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(88, 0, 47,0.58),rgba(118, 0, 70,0.22)_43%,rgba(90, 0, 49,0.34)),linear-gradient(0deg,rgba(47, 2, 25,0.18),rgba(47, 2, 25,0.08))]" />
