...
export function ServiceHighlights() {
  ...
  return (
    <section className="bg-[#f8c5be] px-4 py-14 text-[#4f0b47] sm:px-8">
      <div className="mx-auto max-w-[1340px]">
        <h2 className="m-0 mb-10 text-center font-serif text-[42px] font-light leading-[0.92] tracking-normal text-[#4f0b47] sm:text-[58px] lg:text-[72px]">
        ...
        <div className="relative">
          <button
            ...
            className="absolute left-0 top-[82px] z-10 flex h-11 w-11 -translate-x-2 items-center justify-center rounded-full bg-[#4f0b47] text-[#ffe8e4] shadow-[0_12px_32px_rgba(79, 11, 71,0.18)] transition-transform hover:scale-105 sm:-translate-x-1/2"
          >
            ...
            {highlights.map((item) => (
              ...
              >
                <span className="service-highlight-frame relative flex h-[172px] w-[172px] items-center justify-center rounded-full p-[9px] transition-transform duration-500 group-hover:-translate-y-1 group-hover:scale-[1.03] sm:h-[208px] sm:w-[208px]">
                  <span className="relative z-10 flex h-full w-full items-center justify-center rounded-full bg-[#ffe8e4] p-[7px] shadow-[inset_0_0_0_1px_rgba(79, 11, 71,0.1)]">
                    <span className="relative block h-full w-full overflow-hidden rounded-full bg-[#f3b8b3]">
                      <Image
                        src={item.image}
                        alt={item.alt}
                        fill
                ...
                <span className="text-[18px] font-semibold leading-none text-[#4f0b47]/86 sm:text-[20px]">
                  {item.label}
                </span>
              </Link>
            ))}
          ...
          <button
            ...
            className="absolute right-0 top-[82px] z-10 flex h-11 w-11 translate-x-2 items-center justify-center rounded-full bg-[#4f0b47] text-[#ffe8e4] shadow-[0_12px_32px_rgba(79, 11, 71,0.18)] transition-transform hover:scale-105 sm:translate-x-1/2"
          >
